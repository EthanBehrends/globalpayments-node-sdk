...
var PorticoConnector = /** @class */ (function (_super) {
    ...
    PorticoConnector.prototype.processAuthorization = function (builder) {
        ...
        if (builder.surchargeAmt) {
            elementtree_1.SubElement(block1, "SurchargeAmtInfo").append(elementtree_1.CData(InputValidation_1.validateAmount("portico", builder.surchargeAmt)));
        }
...
function elementToJSONHelper(element) {
    var elementChildren = element.getchildren();
    if (elementChildren.length) {
        var obj = Object.fromEntries(elementChildren.map(elementToJSONHelper));
