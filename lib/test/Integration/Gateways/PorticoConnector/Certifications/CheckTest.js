...
test("001 - consumer personal checking", function (t) {
    t.plan(4);
    var check = Data_1.TestChecks.certification(src_1.SecCode.PPD, src_1.CheckType.Personal, src_1.AccountType.Checking);
...
test("002 - consumer business checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.PPD, src_1.CheckType.Business, src_1.AccountType.Checking);
    return new Promise(function (resolve, reject) {
        check
            .charge(12.0)
            .withCurrency("USD")
...
test("003 - consumer personal savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.PPD, src_1.CheckType.Personal, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(13.0)
            .withCurrency("USD")
...
test("004 - consumer business savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.PPD, src_1.CheckType.Business, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(14.0)
            .withCurrency("USD")
...
test("005 - corporate personal checking", function (t) {
    t.plan(4);
    var check = Data_1.TestChecks.certification(src_1.SecCode.CCD, src_1.CheckType.Personal, src_1.AccountType.Checking, "Heartland Pays");
    return new Promise(function (resolve, reject) {
        check
            .charge(15.0)
            .withCurrency("USD")
...
test("006 - corporate business checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.CCD, src_1.CheckType.Business, src_1.AccountType.Checking, "Heartland Pays");
    return new Promise(function (resolve, reject) {
        check
            .charge(16.0)
            .withCurrency("USD")
...
test("007 - corporate personal savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.CCD, src_1.CheckType.Personal, src_1.AccountType.Savings, "Heartland Pays");
    return new Promise(function (resolve, reject) {
        check
            .charge(17.0)
            .withCurrency("USD")
...
test("008 - corporate business savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.CCD, src_1.CheckType.Business, src_1.AccountType.Savings, "Heartland Pays");
    return new Promise(function (resolve, reject) {
        check
            .charge(18.0)
            .withCurrency("USD")
...
test("009 - egold personal checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.POP, src_1.CheckType.Personal, src_1.AccountType.Checking);
    return new Promise(function (resolve, reject) {
        check
            .charge(11.0)
            .withCurrency("USD")
...
test("010 - egold business checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.POP, src_1.CheckType.Business, src_1.AccountType.Checking);
    return new Promise(function (resolve, reject) {
        check
            .charge(12.0)
            .withCurrency("USD")
...
test("011 - egold personal savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.POP, src_1.CheckType.Personal, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(13.0)
            .withCurrency("USD")
...
test("012 - egold business savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.POP, src_1.CheckType.Business, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(14.0)
            .withCurrency("USD")
...
test("017 - ebronze personal checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.EBronze, src_1.CheckType.Personal, src_1.AccountType.Checking);
    return new Promise(function (resolve, reject) {
        check
            .charge(19.0)
            .withCurrency("USD")
...
test("018 - ebronze business checking", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.EBronze, src_1.CheckType.Business, src_1.AccountType.Checking);
    return new Promise(function (resolve, reject) {
        check
            .charge(20.0)
            .withCurrency("USD")
...
test("019 - ebronze personal savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.EBronze, src_1.CheckType.Personal, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(21.0)
            .withCurrency("USD")
...
test("020 - ebronze business savings", function (t) {
    t.plan(2);
    var check = Data_1.TestChecks.certification(src_1.SecCode.EBronze, src_1.CheckType.Business, src_1.AccountType.Savings);
    return new Promise(function (resolve, reject) {
        check
            .charge(22.0)
            .withCurrency("USD")
